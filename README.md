...
**Document processing and chunking is powered by [Docling](https://github.com/DS4SD/docling)**, which provides advanced PDF parsing and intelligent text segmentation for optimal retrieval performance.
